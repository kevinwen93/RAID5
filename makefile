...
COMPONENT_FILES	:= flex_counter2.sv cache_counter.sv sram_counter.sv sd_data_in_select.sv parity_gen.sv parity_checker.sv  cache_data_in_mux.sv cache_data_out_mux.sv sd_data_out_select.sv sd_error_combine.sv block_no_counter.sv
#COMPONENT_FILES :=
# Specify the name of the top level file (do not include the source folder in the name)
# NOTE: YOU WILL NEED TO SET THIS VARIABLE'S VALUE WHEN WORKING WITH HEIRARCHICAL DESIGNS
# AND THE AUTOMATED GRADING SYSTEM
TOP_LEVEL_FILE	:= control_unit.sv
...
#set_max_delay 1 -from "mode[0]" -to "blk_out[8]"                                  \n\
# set_max_area <area>                                                                   \n\
